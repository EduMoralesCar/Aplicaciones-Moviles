...
export default function App() {
  ...
  const [tareas, setTareas] = useState([
    { id: 1, texto: 'Asistir a la Universidad' },
    { id: 2, texto: 'Desarrollar la practica' },
    { id: 3, texto: 'Almorzar en familia' }
  ]);
...
const styles = StyleSheet.create({
  ...
  btnAgregar: { backgroundColor: '#00B050', padding: 15, borderRadius: 8, alignItems: 'light', marginBottom: 20 },
